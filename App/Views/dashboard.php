            ...
            <ul class="nav" id="side-menu" style="margin-top:1em;">
                ...
                <li>
                    <a href="<?php url('crm'); ?>" class="waves-effect">
                        ...
                        <span class="hide-menu">CRM Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="<?php url('case'); ?>" class="waves-effect">
                        <i class="mdi mdi-ticket fa-fw"></i>
                        <span class="hide-menu">Cases Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="<?php url('hr'); ?>" class="waves-effect">
                        <i class="fa fa-users fa-fw"></i>
                        <span class="hide-menu">HR Dashboard</span>
                    </a>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="javascript:void(0)"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i>
                                <span class="hide-menu">Second Level Item</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                ...
                <li>
                    <a href="javascript:void(0)" class="waves-effect">
                        ...
                        <span lass="hide-menu">Multi Dropdown
                            <span class="fa arrow"></span>
                        </span>
                    </a>
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="javascript:void(0)">
                                        <i class=" fa-fw">T</i>
                                        <span class="hide-menu">Third Level Item</span>
                                    </a>
                                </li>
                                <li>
