            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            <form action="<?php url('hr/payroll/add') ?>" method="post">
                                <div class="row p-30">
                                    <div class="col-md-6">
                                        ...
                                        <select name="employee" id="employee" class="form-control">
                                            ...
                                            <option value="{$employee['id']}">
                                                {$employee['surname']}
                                                {$employee['first_name']}
                                                {$employee['last_name']} | ID: {$employee['idno']}
                                            </option>
                                            {/foreach}
                                        </select>
                                    </div>
                                ...
                                <div class="row p-20 pull-right">
                                    <button class="btn btn-success btn-outline"><i class="fa fa-check"></i> Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
