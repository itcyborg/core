        ...
        <div class="container-fluid">
            <div class="row bg-title">
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Add Case</h4></div>
                <!-- /.page title -->
                <!-- .breadcrumb -->
...
<!--                    </button>-->
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php url('crm')?>">Case Management</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="white-box p-l-20 p-r-20">
                        ...
                        <div class="p-30">
                            <form action="<?php url('case/new')?>" method="post" class="form-horizontal">
                                <div class="form-body">
                                    <div class="form-group">
                                        <select name="customer" id="customer" class="form-control m-10" n:if="$customers">
                                            <option value="">Select Customer</option>
                                            <option n:foreach="$customers as $customer" value="{$customer['id']}">
                                                {$customer['email']|lower}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group m-b-40">
                                        <label for="mname">Issue</label>
                                        <textarea name="issue" id="issue" class="form-control" required></textarea>
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <div class="row pull-right">
                                        <button class="btn btn-primary btn-rounded">Add Case</button>
                                    </div>
                                </div>
                            </form>
                        </div>
